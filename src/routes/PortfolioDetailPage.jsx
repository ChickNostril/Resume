...
const portfolioDetails = {
  starbucks: {
    ...
    contributions: [
      {
        title: "프론트엔드 개발",
        tasks: [
          "UI/UX 클론: HTML, CSS, JavaScript를 사용하여 스타벅스 홈페이지의 UI와 UX를 최대한 유사하게 클론하여, 실제 사이트와 같은 사용자 경험을 제공합니다.",
          "게시판 기능 구현: PHP를 활용해 게시판 기능을 구현하여 사용자가 게시글을 작성, 수정, 삭제할 수 있는 기능을 추가하였습니다.",
          "회원 관리 및 세션 관리: 회원가입과 로그인 기능을 통해 사용자 관리를 구현하였으며, 세션 관리로 로그인 상태를 유지할 수 있도록 했습니다.",
        ],
        achievements: [
          "프론트엔드와 백엔드의 기본적인 기술을 통합하여 웹 애플리케이션을 완성함으로써, 웹 개발의 전반적인 기술을 익힐 수 있었습니다.",
          "실제 웹 사이트와 유사한 디자인과 기능을 구현하여 실무에 가까운 경험을 쌓았습니다.",
          "PHP와 데이터베이스를 활용하여 게시판과 회원 관리 기능을 구현함으로써, 서버와 클라이언트 간의 데이터 흐름을 이해하게 되었습니다.",
        ],
      },
    ],
    positives: [
    ...
    conclusion:
      "이 프로젝트를 통해 프론트엔드와 백엔드 기술을 종합적으로 활용하여 웹 애플리케이션을 개발하는 경험을 쌓을 수 있었습니다. 특히, 프론트엔드와 백엔드의 데이터 연동과 사용자 경험 향상을 위한 UI/UX 개선에 집중하면서, 웹 개발의 기본 원리와 실무 적용 가능성을 높였습니다. 앞으로의 프로젝트에서는 더 많은 기능과 더 나은 사용자 경험을 제공할 수 있는 방향으로 발전시키고자 합니다.",
  },

  pokemon: {
    title: "포켓몬 도감 사이트",
    imageUrl: ["/pokemon.png", "/pokemon.png"],
    description:
    ...
    contributions: [
      {
        title: "웹 프론트엔드 개발",
        tasks: [
          "UI/UX 구현: React와 Styled-components를 사용하여 포켓몬 도감의 UI와 UX를 직관적이고 사용자 친화적으로 설계하였습니다.",
          "OAuth 로그인: Firebase Authentication을 이용해 Google OAuth 로그인을 구현하여 사용자의 인증을 간편하게 처리하였습니다.",
          "데이터 관리 및 필터링: 포켓몬 데이터를 효과적으로 관리하고, 사용자가 이름, 타입 등 다양한 기준으로 포켓몬을 필터링할 수 있는 기능을 구현하였습니다.",
          "배포: Firebase Hosting을 활용하여 프로젝트를 안정적이고 신속하게 배포하였으며, 사용자가 언제든지 접근할 수 있도록 웹사이트를 공개하였습니다.",
        ],
        achievements: [
          "React의 컴포넌트 기반 구조를 최대한 활용하여 유지보수성과 재사용성을 높였습니다.",
          "Firebase를 통한 인증 및 배포 경험을 쌓아, 서버리스 환경에서의 웹 애플리케이션 운영을 이해하게 되었습니다.",
          "다양한 포켓몬 데이터를 시각적으로 정리하고 필터링하여 사용자가 원하는 정보를 쉽게 찾을 수 있는 UX를 제공하였습니다.",
        ],
      },
    ],
    positives: [
    ...
    negatives: [
      "초기 데이터 수집 및 정제 과정에서 시간이 많이 소요되었으며, 더 많은 포켓몬 정보를 포함하지 못한 점이 아쉬웠습니다.",
      "기능 확장성 면에서 추가적인 포켓몬 비교 기능 등을 더 구현하지 못한 부분이 있었습니다.",
    ],
    conclusion:
      "포켓몬 도감 웹사이트 프로젝트는 React와 Styled-components를 이용해 프론트엔드 개발을 집중적으로 경험할 수 있었던 프로젝트입니다. Firebase를 활용하여 인증 및 배포의 간소화를 이루며, 전체적인 웹 개발과 운영의 흐름을 이해하고 적용할 수 있었습니다. 향후 프로젝트에서는 더 많은 기능과 데이터 관리의 효율성을 높이는 방향으로 발전시키고자 합니다.",
  },

  community: {
    title: "아무 말 대잔치",
    imageUrl: ["/community.png", "/community.png"],
    description:
    ...
    contributions: [
      {
        ...
        tasks: [
          ...
          "사용자 인증 및 인가를 구현하여 회원가입, 로그인, 로그아웃 기능을 통해 사용자 관리를 강화했습니다.",
          "CRUD 기능을 완전히 지원하는 게시판을 구현하여 사용자가 게시글을 자유롭게 작성하고 관리할 수 있도록 하였습니다.",
        ],
        achievements: [
          "Express와 MySQL을 활용한 서버와 데이터베이스 연동 경험을 통해 백엔드 개발에 대한 이해를 높였습니다.",
          "React를 이용한 컴포넌트 기반의 프론트엔드 개발을 통해 UI/UX 개선과 유지보수성을 향상시켰습니다.",
          "사용자 인증 및 권한 관리 기능을 통해 웹 애플리케이션의 보안성을 강화했습니다.",
        ],
      },
    ],
    positives: [
      "Express와 MySQL을 활용하여 서버와 데이터베이스를 유기적으로 연결하고, 데이터를 효율적으로 처리하는 경험을 쌓았습니다.",
      "프론트엔드와 백엔드의 데이터 연동을 통해 전반적인 웹 개발 흐름을 이해하고 구현할 수 있었습니다.",
    ],
    negatives: [
      "초기 기획 단계에서 기능과 설계가 명확하지 않아 개발 속도가 다소 늦어진 점이 아쉬웠습니다.",
      "더 많은 기능을 구현하지 못하고 기본적인 게시판 기능에 그친 점이 아쉬웠습니다.",
    ],
    conclusion:
      "아무 말 대잔치 프로젝트를 통해 Express와 MySQL의 실제 사용 경험을 쌓고, 프론트엔드와 백엔드를 통합적으로 개발하는 데 많은 배움을 얻을 수 있었습니다. 특히, 데이터 흐름과 사용자 관리의 중요성을 깨달았으며, 향후 프로젝트에서는 기획 단계에서부터 명확한 목표 설정과 기능 확장을 통해 더 나은 웹 서비스를 제공할 수 있도록 노력하고자 합니다.",
  },

  hackerton: {
    title: "AI 기반 대화형 장소 추천 시스템",
    imageUrl: ["/hackerton.png", "/pokemon.png"],
    description:
    ...
    contributions: [
      ...
      },
      {
        ...
        achievements: [
          "백엔드 팀과의 원활한 소통으로 API 연동 시 발생할 수 있는 문제를 최소화하여, 개발 속도와 안정성을 높였습니다.",
    ...
    negatives: [
      ...
      "초기 AI 학습 데이터의 부족으로 인해 일부 추천 결과의 정확도가 낮았던 점이 있었습니다.",
    ],
    conclusion:
