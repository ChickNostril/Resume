...
const portfolioDetails = {
  ...
  hackerton: {
    ...
    motivation:
      "이 프로젝트는 해커톤의 일환으로, 프론트엔드와 백엔드 간의 협업을 통해 실질적인 문제 해결 능력을 향상시키고, 공공 데이터를 활용한 서비스 개발 경험을 쌓기 위해 시작했습니다.\n 특히, 관광객들이 다양한 선택지 속에서 적합한 장소를 찾는 데 어려움을 겪는 문제를 AI 기반의 대화형 시스템으로 해결하고자 했습니다.",
    contributions: [
      {
        title: "프론트엔드 개발",
        tasks: [
  ...
  sumda: {
    title: "숨쉬는 다람쥐 숨다",
    imageUrl: [
      `${process.env.PUBLIC_URL}/sumda/sumda-proto.png`,
      `${process.env.PUBLIC_URL}/sumda/sumda-final.png`,
    ],
    description:
